                ...
                <div class="dashboard-main">
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                <span class="stat-label" style="color: black">Posting Credits Left</span>
                                <span class="stat-value" style="color: black">{{ number_format((int) (auth()->user()->job_posting_balance ?? 0)) }}</span>
                            </div>
                        </div>
                    </div>
